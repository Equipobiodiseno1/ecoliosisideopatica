                ...
                new CountDownTimer(duration, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        Toast.makeText(getApplicationContext()
                                ,"Su tratamiento ha terminado",Toast.LENGTH_LONG).show();//esto para mostrar el mensaje al terminar
                    }
                }.start();
